...
def argparser():
    ...
    parser.add_argument('--fit_repo', '-fr', type=str, dest='fit_repo',
                        default='/mnt/lustre/scratch/epp/jp643/antinu/param_fitting/RAT7.0.15/likelihoods_test/', help='Folder to save recombined root files with tracking information in.')
    ...
    parser.add_argument('--Nbins', '-N', type=int, dest='Nbins', default=10, help='Number of bins in x and y directions.')
